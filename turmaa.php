...
<Section>
    ...
    $sql = "SELECT * FROM alunos WHERE turma = 'A' and situacao = 'aprovado' and frequencia != 'Desistiu'";
    $res = $coneccao->query($sql);
    $aprovados = $res->num_rows;
    //echo "Aprovados: ".$aprovados;

    $sql = "SELECT * FROM alunos WHERE turma = 'A' and situacao = 'reprovado' and frequencia != 'Desistiu'";
    $res = $coneccao->query($sql);
    $reprovados = $res->num_rows;
    //echo "Reprovados: ".$reprovados;

    $sql = "SELECT * FROM alunos WHERE turma = 'A' and media < 5 and frequencia != 'Desistiu'";
    $res = $coneccao->query($sql);
    $menorede5 = $res->num_rows;
    //echo "Menore de 5: ".$menorede5;

    $sql = "SELECT * FROM alunos WHERE turma = 'A' and media > 15 and frequencia != 'Desistiu'";
    $res = $coneccao->query($sql);
    ...
    <li>
     Na turma A da escola Primaria Completa de Dongane unm <strong>total de <?=$total?></strong> estudantes, foram <strong>aprovados <?=$aprovados?></strong> aluons e <strong>reprovaram <?=$reprovados?></strong>
      dos quais <?=$menorede5?> reprovaram com  uma nota <strong>imferior a 5 valores</strong> e <?=$maiorde15?> passaram com uma nota <strong>superior a 15 Valores</strong>.
    </li>
    <br>
    <li>
