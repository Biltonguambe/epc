...
<?php
    ...
    $sql = "SELECT * FROM alunos WHERE turma = 'D' and situacao = 'aprovado' and frequencia != 'Desistiu' ";
    $res = $coneccao->query($sql);
    $aprovados = $res->num_rows;
    //echo "Aprovados: ".$aprovados;

    $sql = "SELECT * FROM alunos WHERE turma = 'D' and situacao = 'reprovado' and frequencia != 'Desistiu'";
    $res = $coneccao->query($sql);
    $reprovados = $res->num_rows;
    //echo "Reprovados: ".$reprovados;

    $sql = "SELECT * FROM alunos WHERE turma = 'D' and media < 5  and frequencia != 'Desistiu'";
    $res = $coneccao->query($sql);
    $menorede5 = $res->num_rows;
    //echo "Menore de 5: ".$menorede5;

    $sql = "SELECT * FROM alunos WHERE turma = 'D' and media > 15 and frequencia != 'Desistiu' ";
    $res = $coneccao->query($sql);
...
?>
    ...
    <li>
      Na turma D da Escola Primaria Completa de Domgame num <strong>total de <?=$total?></strong> estudantes, foram <strong>aprovados <?=$aprovados?></strong> aluons e <strong>reprovaram <?=$reprovados?></strong>
